...
//	String root = "C:\\Users\\LENOVO\\Downloads\\";
	...
	LuckyDrawCalculation(boolean test, FireStoreConnection fb, ArrayList<String> keys,
			LuckyDrawController luckyDrawController, int id, int luckydrawCount) {
		if (test) {
	...
	public void callBusinessLogic() {
		...
		System.out.println("Time for Shuffle Thread:-" + (End4 - start4));
		...
		luckyDrawController.criteriaFile.put("range0", range0);
		luckyDrawController.criteriaFile.put("range1", range1);
		luckyDrawController.criteriaFile.put("range2", range2);
		luckyDrawController.criteriaFile.put("range3", range3);
		luckyDrawController.criteriaFile.put("range4", range4);
		luckyDrawController.criteriaFile.put("range5", range5);
		luckyDrawController.criteriaFile.put("range6", range6);
		luckyDrawController.criteriaFile.put("range7", range7);
		...
		System.out.println("Time for calculating user from json Thread:-" + (End1 - start1));
		...
		System.out.println("Time for calculating Online Users Thread:-" + (End2 - start2));

		Range<Integer> category1 = Range.between(range0.getInt("minUserBalance"), range0.getInt("maxUserBalance"));

		Range<Integer> category2 = Range.between(range1.getInt("minUserBalance"), range1.getInt("maxUserBalance"));

		Range<Integer> category3 = Range.between(range2.getInt("minUserBalance"), range2.getInt("maxUserBalance"));

		Range<Integer> category4 = Range.between(range3.getInt("minUserBalance"), range3.getInt("maxUserBalance"));

		Range<Integer> category5 = Range.between(range4.getInt("minUserBalance"), range4.getInt("maxUserBalance"));

		Range<Integer> category6 = Range.between(range5.getInt("minUserBalance"), range5.getInt("maxUserBalance"));

		Range<Integer> category7 = Range.between(range6.getInt("minUserBalance"), range6.getInt("maxUserBalance"));

		Range<Integer> category8 = Range.between(range7.getInt("minUserBalance"), range7.getInt("maxUserBalance"));

		Range<Integer> category9 = Range.between(range8.getInt("minUserBalance"), range8.getInt("maxUserBalance"));

		Range<Integer> category10 = Range.between(range9.getInt("minUserBalance"), range9.getInt("maxUserBalance"));

		Range<Integer> category11 = Range.between(range10.getInt("minUserBalance"), range10.getInt("maxUserBalance"));

		int subOnline = (range0.getInt("numberOfUsers") + range1.getInt("numberOfUsers")
				+ range2.getInt("numberOfUsers") + range3.getInt("numberOfUsers") + range4.getInt("numberOfUsers")
				+ range5.getInt("numberOfUsers") + range6.getInt("numberOfUsers") + range7.getInt("numberOfUsers")
				+ range8.getInt("numberOfUsers") + range9.getInt("numberOfUsers") + range10.getInt("numberOfUsers"));
		...
		for (j = 1; j < keys.size(); j++) {
			...
			if (json.has("Online") && json.getBoolean("Online") && json.has("new_balance") && json.has("datetime")) {
				int userBalance = json.getInt("new_balance");
				String date = json.getString("datetime");
				String userType = getUserType(date);

				if (!weekjedis.exists(key)) {
					// Category1

					if (userType.equalsIgnoreCase(NEW_USER)
						...
						resultJson.put("datetime", cdate.getCurrentDateTimeString());
						resultJson.put("datetime", cdate.getCurrentDateTimeString());

						resultJson.put("LuckyDraw", luckydrawCount);

						/*
						 * JSONObject resultJson = new JSONObject(); resultJson.put("phone",
						 * json.getString("phone")); resultJson.put("accountcode",
						 * json.getString("accountcode")); resultJson.put("username",
						 * json.getString("username")); resultJson.put("event", "lucky_winners");
						...
						if (userCountNewJsonFile.get(0) > luckyDrawController.newUserRange0) {
							...
							weekjedis.set(key, resultJson.toString());
					...
					else if (userType.equalsIgnoreCase(NEW_USER)
					...
					else if (category1.contains(userBalance) && userType.equalsIgnoreCase(OLD_USER)
					...
					else if (category2.contains(userBalance) && userType.equalsIgnoreCase(OLD_USER)
					...
					else if (category3.contains(userBalance) && userType.equalsIgnoreCase(OLD_USER)
					...
					else if (category4.contains(userBalance) && userType.equalsIgnoreCase(OLD_USER)
					...
					else if (category5.contains(userBalance) && userType.equalsIgnoreCase(OLD_USER)
					...
					else if (category6.contains(userBalance) && userType.equalsIgnoreCase(OLD_USER)
					...
					else if (category7.contains(userBalance) && userType.equalsIgnoreCase(OLD_USER)
					...
					else if (category8.contains(userBalance) && userType.equalsIgnoreCase(OLD_USER)
					...
					else if (category9.contains(userBalance) && userType.equalsIgnoreCase(OLD_USER)
					...
					else if (category10.contains(userBalance) && userType.equalsIgnoreCase(OLD_USER)
					...
					// Category11
					...
					else if (category11.contains(userBalance) && userType.equalsIgnoreCase(OLD_USER)
						...
						setGiveAwayResultDocument(jedis, keys, giveAwayObject, luckyDrawController.totalOnlineUser,
								userCountGAJsonFile, subOnline);
						...
						if (userCountGAJsonFile.get(0) > luckyDrawController.giveAwayR0) {
							...
							if (luckyDrawController.cuponBrands.size() > 0) {
								String brandName = luckyDrawController.cuponBrands
										.get(new Random().nextInt(luckyDrawController.cuponBrands.size()));

								JSONObject obj = luckyDrawController.cuponsDetail.get(brandName);
								Range<Integer> category12 = Range.between(obj.getInt("minUserBalance"),
										obj.getInt("maxUserBalance"));
								if (category12.contains(userBalance)) {
									JSONObject resultJson = new JSONObject();
									resultJson.put("phone", json.getString("phone"));
									resultJson.put("accountcode", json.getString("accountcode"));
									resultJson.put("username", json.getString("username"));
									resultJson.put("rewardType", obj.getString("reward"));
									resultJson.put("quantity", obj.getInt("quantity"));
									resultJson.put("brandName", obj.getString("brandName"));
									resultJson.put("couponId", obj.getInt("couponId"));
									resultJson.put("billing", false);
									resultJson.put("datetime", cdate.getCurrentDateTimeString());
									// resultJson.put("Online", true);
									resultJson.put("LuckyDraw", luckydrawCount);
									if (obj.getInt("numberOfUsers") > obj.getInt("count")) {
										int z = obj.getInt("count");
										z = z + 1;
										obj.put("count", z);
										luckyDrawController.cuponsDetail.put(brandName, obj);
										setjedis.set(key, resultJson.toString());
										weekjedis.set(key, resultJson.toString());
									}
					...
					/*
					 * ArrayList<String> sb= new ArrayList<String>(); for (int x = 0; x <
					 * luckyDrawController.couponJson.length(); x++) {
					 * 
					 * JSONObject obj = luckyDrawController.cuponsDetail
					 * .get(luckyDrawController.couponJson.getJSONObject(x).getString("brandName"));
					 * if (obj.getInt("numberOfUsers") == obj.getInt("count") &&
					 * !sb.contains(obj.getString("brandName")) ) {
					 * sb.add(obj.getString("brandName"));
					 * 
					 * } }
					 */
					if (userCountGAJsonFile.get(4) == luckyDrawController.giveAwayR4
							&& userCountGAJsonFile.get(3) == luckyDrawController.giveAwayR3
							...
							&& userCountNewJsonFile.get(9) == luckyDrawController.newUserRange9
							&& userCountNewJsonFile.get(10) == luckyDrawController.newUserRange10
					// && sb.size() == luckyDrawController.couponJson.length()
					) {
		...
		/*
		 * System.out.println("assume count cat1 new "+userCountNewJsonFile.get( 0));
		 * System.out.println("assume count cat2 new "+userCountNewJsonFile.get( 1));
		 * System.out.println("assume count cat3 new "+userCountNewJsonFile.get( 2));
		 * System.out.println("assume count cat4 new "+userCountNewJsonFile.get( 3));
		 * System.out.println("assume count cat5 new "+userCountNewJsonFile.get( 4));
		 * System.out.println("assume count cat6 new "+userCountNewJsonFile.get( 5));
		 * System.out.println("assume count cat7 new "+userCountNewJsonFile.get( 6));
		 * System.out.println("assume count cat8 new "+userCountNewJsonFile.get( 7));
		 * System.out.println("assume count cat9 new "+userCountNewJsonFile.get( 8));
		 * System.out.println("assume count cat10 new "+userCountNewJsonFile.get (9));
		 * System.out.println("assume count cat11 new "+userCountNewJsonFile.get (10));
		 * 
		 * 
		 * System.out.println("assume count cat1 old "+userCountOldJsonFile.get( 0));
		 * System.out.println("assume count cat2 old "+userCountOldJsonFile.get( 1));
		 * System.out.println("assume count cat3 old "+userCountOldJsonFile.get( 2));
		 * System.out.println("assume count cat4 old "+userCountOldJsonFile.get( 3));
		 * System.out.println("assume count cat5 old "+userCountOldJsonFile.get( 4));
		 * System.out.println("assume count cat6 old "+userCountOldJsonFile.get( 5));
		 * System.out.println("assume count cat7 old "+userCountOldJsonFile.get( 6));
		 * System.out.println("assume count cat8 old "+userCountOldJsonFile.get( 7));
		 * System.out.println("assume count cat9 old "+userCountOldJsonFile.get( 8));
		 * System.out.println("assume count cat10 old "+userCountOldJsonFile.get (9));
		 * System.out.println("assume count cat11 old "+userCountOldJsonFile.get (10));
		 * 
		 * 
		...
		System.out.println("Time for calculating GA and GP:-" + (End3 - start3));
